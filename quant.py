...
# Stap 7: Resultaten naar CSV opslaan
...
def run_analysis(sopr_path, mvrv_path, price_path):
    ...
    sopr_buy_range = [x / 10.0 for x in range(6, 8)]  # Drempel voor koop tussen 0.6 en 2.0
    sopr_sell_range = [x / 10.0 for x in range(14, 31)]  # Drempel voor verkoop tussen 1.4 en 3.0
    mvrv_buy_range = [x / 10.0 for x in range(3, 7)]  # Drempel voor koop tussen 0.6 en 2.0
    mvrv_sell_range = [x / 10.0 for x in range(20, 31)]  # Drempel voor verkoop tussen 2.0 en 3.0
    ...
    save_to_csv(top_10_with_weights)
